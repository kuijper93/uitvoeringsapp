                        ...
                        <div className="col-span-8 space-y-2">
                          <div className="bg-blue-100 p-2 rounded text-xs">
                            <div className="grid grid-cols-3 gap-2">
                              ...
                              <div>
                                ...
                                <p className="text-xs">{selectedWorkOrder.installationXCoord}</p>
                              </div>
                              <div>
                                <label className="text-xs font-medium">Y coördinaat</label>
                                <p className="text-xs">{selectedWorkOrder.installationYCoord}</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="space-y-2 bg-green-50 p-2 rounded">
                              <p className="text-xs font-medium mb-1">Verkeersplan</p>
                              <div className="space-y-2">
                                <div className="space-y-1">
                                  <label className="text-xs">Uitvoering</label>
